...
def weight_variable(name, shape):
    return tf.compat.v1.get_variable(name, shape=shape, initializer=tf.contrib.layers.xavier_initializer())
...
x = tf.compat.v1.placeholder(tf.float32, shape=[None, 66, 200, 3], name="input_x")
